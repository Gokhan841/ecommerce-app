          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="bg-gradient-to-r from-purple-500 to-pink-500 p-8 text-center"
              >
                <motion.h2
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
              ...
              <div className="p-8">
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-3 rounded-xl font-medium hover:from-purple-600 hover:to-pink-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {formik.isSubmitting ? (
                      <motion.div
                        animate={{ rotate: 360 }}
...
// Original SignIn component kept for backward compatibility
const SignIn = () => {
  return <SignInModal isOpen={true} onClose={() => {}} onSwitchToSignUp={() => {}} />;
};
